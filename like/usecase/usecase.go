...
func (luc *LikeUseCase) GetPostLike(id, userid int) (models.Like, error) {
	return luc.repository.GetPostLike(id, userid)
}

func (luc *LikeUseCase) GetCommentLike(id, userid int) (models.Like, error) {
	return luc.repository.GetCommentLike(id, userid)
}

func (luc *LikeUseCase) LikePost(idPost, idUser int, like bool) (models.Like, error) {
...
func (luc *LikeUseCase) LikeComment(idPost, idUser int, like bool) (models.Like, error) {
